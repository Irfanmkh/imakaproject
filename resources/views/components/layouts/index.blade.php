...
<header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
    <div class="container">
      <div class="flex items-center justify-between relative">
        ...
        <div class="px-4">
          <a href="#home" class="font-bold text-xl lg:text-2xl text-primary block py-6 font-monobuntu tracking-wider">Syahrandy Waskito</a>
        </div>
        ...
        <div class="flex items-center px-4">
          ...
          <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none font-monobuntu">
            <ul class="block lg:flex">
              <li class="group">
                <a href="#home" class="text-base text-dark py-2 mx-6 flex group-hover:underline group-hover:text-primary lg:text-lg tracking-wider">Home Page</a>
              </li>
              <li class="group">
                <a href="#about" class="text-base text-dark py-2 mx-6 flex group-hover:text-primary group-hover:underline lg:text-lg tracking-wider">Note</a>
              </li>
              <li class="group">
                <a href="#portfolio" class="text-base text-dark py-2 mx-6 flex group-hover:text-primary group-hover:underline lg:text-lg tracking-wider">Portfolio</a>
              </li>
              <li class="group">
                <a href="#blog" class="text-base text-dark py-2 mx-6 flex group-hover:text-primary group-hover:underline lg:text-lg tracking-wider">Blog</a>
              </li>
              <li class="group">
                <a href="#skills" class="text-base text-dark py-2 mx-6 flex group-hover:text-primary group-hover:underline lg:text-lg tracking-wider">Skills</a>
              </li>
              <li class="group">
                <a href="#contact" class="text-base text-dark py-2 mx-6 flex group-hover:text-primary group-hover:underline lg:text-lg tracking-wider">Contact</a>
              </li>
            </ul>
          </nav>
        </div>
    ...
    <!-- * Hero Section -->
    <section id="home" class="pt-36 lg:pt-28">
        <div class="container">
        ...
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    <h4 class="font-bold uppercase text-primary mb-3 font-monobuntu tracking-widest">Note for me</h4>
                    <h2 class="font-bold text-dark text-3xl mb-3 max-w-md lg:text-4xl">Run, die, Resurrect, Repeat</h2>
                    <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">
                        <span class="italic text-primary font-semibold">Run, Die, Resurrect, Repeat</span> adalah sebuah
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semibold text-dark mb-4 text-2xl lg:text-3xl lg:pt-10"><span
                            class="underline italic">Social Media</h3>
                    <p class="font-medium text-base text-secondary mb-5 lg:text-lg">
                        Ada kalanya sendirian itu tidak baik untuk kesehatan badan maupun mental. Maka dari itu jika
                        berkenan, silahkan kunjungi sosial media saya dibawah ini 👍.
                    </p>

                    <div class="flex items-center">
                        <!-- * Github -->
                        <a href="https://github.com/syahrandywaskito" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white transition duration-200">
            ...
            <div class="w-full px-4">
                ...
                <div class="max-w-xl mx-auto text-center mb-16">
                    <h4 class="font-semibold text-lg text-primary mb-2 font-monobuntu tracking-widest uppercase">
                        Portfolio</h4>
                    <h2 class="font-bold text-dark text-3xl mb-4">Newest Project</h2>
                    <p class="font-medium text-base text-secondary">Ini adalah project-project yang sudah saya buat
                        sejauh ini. <br>(Kebanyakan berupa Web Project)</p>
                </div>

                <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
                    <div class="mb-10 p-4 md:w-1/2">
                        <div class="rounded-md shadow-lg overflow-hidden bg-white">
                            <img src="img/first-portfolio.png" alt="duck" width="100%">
                            <div class="p-3">
                                <h3 class="font-semibold text-dark text-xl mt-5 mb-3">First Portfolio</h3>
                                <p class="font-medium text-base text-secondary">Project Portfolio Pertama Saya, dibuat
                                    menggunakan bootstrap</p>
                            </div>
                        </div>
                    </div>
                    <div class="mb-10 p-4 md:w-1/2">
                        <div class="rounded-md shadow-lg overflow-hidden bg-white">
                            <img src="img/examp-project.png" alt="duck" width="100%">
                            <div class="p-3">
                                <h3 class="font-semibold text-dark text-xl mt-5 mb-3">Examp Project</h3>
                                <p class="font-medium text-base text-secondary">Project ini dibuat menggunakan PHP
                                    untuk server side, dan css framework Bootstrap. Project ini dibuat untuk memenuhi
                                    tugas akhir sekolah</p>
                            </div>
                        </div>
                    </div>
                    <div class="mb-10 p-4 md:w-1/2">
                        <div class="rounded-md shadow-lg overflow-hidden bg-white">
                            <img src="img/display-fids.png" alt="duck" width="100%">
                            <div class="p-3">
                                <h3 class="font-semibold text-dark text-xl mt-5 mb-3">FIDS Display</h3>
                                <p class="font-medium text-base text-secondary">Project ini dibuat menggunakan Laravel
                                    dan Tailwindcss. Project ini dibuat waktu magang, untuk menampilkan jadwal FIDS
                                    dengan system remote online jarak jauh</p>
                            </div>
                        </div>
                    </div>
                    <div class="mb-10 p-4 md:w-1/2">
                        <div class="rounded-md shadow-lg overflow-hidden bg-white">
                            <img src="img/library-managament.png" alt="duck" width="100%">
                            <div class="p-3">
                                <h3 class="font-semibold text-dark text-xl mt-5 mb-3">Library Management</h3>
                                <p class="font-medium text-base text-secondary">Project ini dibuat menggunakan PHP dan
                                    bootstrap. Project ini dibuat sebagai tugas SaaS dengan tema managemen perpustakaan
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full pt-10 border-t border-slate-700">
                ...
                <p class="font-medium text-xs text-slate-500 text-center">
                    Created by <a href="https://github.com/syahrandywaskito" target="_blank"
                        class="font-bold text-primary">Syahrandy Waskito</a>, using <a href="https://tailwindcss.com/"
                        target="_blank" class="font-bold text-sky-500">Tailwind CSS</a>.
                </p>
