...
<div class="w-full z-50 top-0 py-3 sm:py-5 fixed" :class="{'bg-black bg-opacity-70': scrolled}">
    <div class="container flex items-center justify-center">
        <div class="hidden lg:block">
            <ul class="flex items-center space-x-6">
                <li class="group pl-6">
                    <span @click="triggerNavItem('#about')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">About</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#services')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Services</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#portfolio')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Portfolio</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#clients')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Clients</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#work')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Work</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#statistics')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Statistics</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#blog')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Blog</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
                <li class="group pl-6">
                    <span @click="triggerNavItem('#contact')" :class="{'text-purple-500': scrolled}" class="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Contact</span>
                    <span class="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span>
                </li>
            </ul>
        </div>
        ...
        <div>
                ...
                <div class="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
                    <div class="flex flex-col items-center justify-center lg:flex-row">
                        <div class="rounded-full border-8 border-primary shadow-xl">
                            <img src=" {{ Storage::url($jumbotron->thumbnail) }}" class="h-48 rounded-full sm:h-56"
                                alt="author" />
                        </div>
                        <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                            <h1
                                class="text-center font-header text-4xl text-white sm:text-left sm:text-5xl md:text-6xl">
                                Hello I'm {{ $jumbotron->judul }}
                            </h1>
                ...
                <div class="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
                    <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                        ...
                        <h4 class="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                            I'm {{ $jumbotron->judul }}, a Web Designer & Photographer
                        </h4>
            ...
            <div class="container py-16 md:py-20" id="portfolio">
                ...
                <div class="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
                    ...
                    <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                        <img src="/assets/img/portfolio-microsoft.jpeg" class="w-full shadow"
                            alt="portfolio image" />
                    </a>
                </div>
            </div>
    ...
    new Vue({
        ...
        data() {
            return {
                scrolled: false, // To track the scroll state
            };
        },
        mounted() {
        ...
        methods: {
            handleScroll() {
                const jumbotronHeight = document.getElementById('jumbotron').offsetHeight;
                // Change scrolled to true when scrolling past jumbotron
                this.scrolled = window.scrollY > jumbotronHeight;
            }
        }
    });
</script>
